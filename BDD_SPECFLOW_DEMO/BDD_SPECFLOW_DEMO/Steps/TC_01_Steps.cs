...
namespace BDD_SPECFLOW_DEMO.Steps
{
    ...
    public class TC_01Steps
    {
        ...
        {
            driver = new ChromeDriver(@"E:\Automation practice\BDD_SPECFLOW_DEMO\BDD_SPECFLOW_DEMO\BDD_SPECFLOW_DEMO\Drivers");
        ...
        {
            IWebElement errorMsg = driver.FindElement(By.XPath(MyAccountUI.INVALID_ERROR_MSG));
